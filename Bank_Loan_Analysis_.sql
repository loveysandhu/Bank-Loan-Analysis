/* =============================================================
   BANK LOAN ANALYSIS - SQL QUERIES (MySQL)
   Table: bank_loan_data
   Note: "MTD" = December (month 12), "PMTD" = November (month 11)
   ============================================================= */


/* =============================================================
   SECTION A - BANK LOAN REPORT | SUMMARY
   ============================================================= */
...
/* =============================================================
   SECTION B - BANK LOAN REPORT | OVERVIEW
   ============================================================= */
...
-- By Purpose, filtered to Grade A (example of grade filter)
SELECT
    purpose AS PURPOSE,
    COUNT(id) AS Total_Loan_Applications,
    SUM(loan_amount) AS Total_Funded_Amount,
